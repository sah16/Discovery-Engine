...
async def synthesize_insights(query: str, retrieved_context: List[dict], metrics: dict) -> dict:
    ...
    2. "executive_summary": A string containing a 2-3 sentence conversational answer to the user's analytical query. If the query is framed as a question seeking understanding (e.g., "How do users..."), directly answer it based on the evidence. If the query is just a vague keyword string or topic (e.g., "search", "error"), output null or an empty string.
